          ...
          <div className="flex items-center gap-3">
            {post.status === 'published' && (
              <button
                ...
                disabled={saving}
                className="flex items-center gap-2 px-4 py-2 border border-tertiary/40 text-tertiary rounded-lg hover:bg-tertiary/10 transition-colors disabled:opacity-50"
              >
