    ...
    return (
        <div className="flex-1 flex items-center justify-center bg-[#0a0a0a] text-white">
            ...
            >
                ...
                <button
                    onClick={handleLogin}
                    className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-6 py-3 font-medium text-black transition-transform hover:scale-[1.02] active:scale-[0.98]"
                >
