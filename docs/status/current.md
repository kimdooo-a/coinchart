...
| 항목 | 값 |
|------|-----|
| **마지막 세션** | 2026-05-23 (세션 25 — R2/T03 코인룸 실데이터: `/coin/[symbol]` 6종을 mock→실데이터 전환. 2파일: `app/coin/[symbol]/page.tsx` + 신규 `lib/community/coin-queries.ts`. 디스패치 배너 R2-T04였으나 사용자 "T03 강행". 병렬 cs T01 24 선점 → 25 채택. ※병렬 R2 T01/T02와 동시 cs 경합 — 컨덕터 정정) |
