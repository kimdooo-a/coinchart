export const TEMPLATES = {
    ...
    HOLD: {
        ...
        risk: "높은 변동성({volatility})으로 인해 급격한 시세 변화 가능성이 있습니다. 현재 기술적 지표 {grade} 등급으로 관망이 유리한 구간입니다.",
        watch: "{watchNext} 지지선 이탈 여부를 주의 깊게 살피며, 확실한 신호 발생 시까지 대기하는 것이 좋습니다."
    },
    STOP_LOSS: {
        evidence: "하락 통계가 {dropProb}%로 우세하게 나타나고 있습니다. 주요 지표인 {topSignals}에서 약세 패턴이 확인되었습니다.",
